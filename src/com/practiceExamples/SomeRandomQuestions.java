...
public class SomeRandomQuestions {
    public static void main(String[] args) {
        ...
        ArrayList<String> list = new ArrayList<>(Arrays.asList("Alice", "Bob", "Charlie", "David", "Alice", "Bob", "Charlie", "David"));
    ...
    static List<Employee> testEmployee() {
        ...
        return employees.stream().sorted(Comparator.comparingDouble(Employee::getSalary).thenComparing(Employee::getName)).collect(Collectors.toList());
    }
