...
public class ConvertDateToBinary {
    public String convertDateToBinary(String date) {
        ...
        return convertDateToBinaryUsingRecursion(Integer.parseInt(parts[0])) + "-" + convertDateToBinaryUsingRecursion(Integer.parseInt(parts[1])) + "-" + convertDateToBinaryUsingRecursion(Integer.parseInt(parts[2]));
    }
