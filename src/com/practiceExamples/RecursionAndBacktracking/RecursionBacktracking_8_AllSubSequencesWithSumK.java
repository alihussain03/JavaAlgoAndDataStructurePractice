...
public class RecursionBacktracking_8_AllSubSequencesWithSumK {
    ...
    static void listOfALLSequencesWithSumK(int[] candidates, int target, int index, ArrayList<Integer> current, List<List<Integer>> result) {
    ...
    static void findSubSequencesWithSumKAndPrint(int[] numbers, int index, ArrayList<Integer> output, int target, int sum) {
