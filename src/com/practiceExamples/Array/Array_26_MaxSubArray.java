...
/**
 * https://leetcode.com/problems/maximum-sum-of-distinct-subarrays-with-length-k/description/ Fixed-size Sliding Window
 * with Additional Constraint (Distinct elements) This function finds the maximum sum of a subarray with exactly k
 * elements, where all elements are distinct. {1, 2, 3, 4, 5, 1, 2, 3}, k=3, Output=12 (3, 4, 5)
 */
