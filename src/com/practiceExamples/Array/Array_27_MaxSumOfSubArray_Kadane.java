...
public class Array_27_MaxSumOfSubArray_Kadane {
   ...
   * can be done using Sliding Window ? This function finds the maximum sum of a contiguous subarray in nums using
   * Kadane's Algorithm. {-2, 1, -3, 4, -1, 2, 1, -5, 4}, output = 6 -> [4,-1,2,1]
   */
